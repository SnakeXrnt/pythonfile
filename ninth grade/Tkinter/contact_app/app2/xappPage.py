...
class AppPage(tk.Frame):
	...
	def create_left_frame(self):
		self.left_frame = tk.Frame(self, bg="pink", width=self.settings.width//3)
	...
	def create_right_frame(self):
		...
		self.right_frame.grid_columnconfigure(0, weight=1) #1/3
	...
	def create_left_header(self):
		...
		self.searchBox_frame = tk.Frame(self.left_frame, width=frame_w, height=frame_h//4)
	...
	def create_right_header(self):
		...
		self.fullName_Label = tk.Label(self.detail_header, text="Anas Azhar", font=("Arial", 35))
	...
	def create_right_footer(self):
		...
		for feature in features:
			button = tk.Button(self.detail_footer, text=feature, font = ("Arial", 12), bg="white")
