...
class Page01(tk.Frame):
    ...
    def create_frame03(self):
        ...
        button0 = tk.Button(frameButton0, text='     0     ', font=("Arial",26, "bold"), image=self.pixelButton, compound="c", width=width_btn, height=height_btn)
    ...
    #   buttondiv = tk.Button(frame04, text='   /   ', font=("Arial",26, "bold"), image=self.pixelButton, compound="c", width=width_btn, height=height_btn, bg="orange")
