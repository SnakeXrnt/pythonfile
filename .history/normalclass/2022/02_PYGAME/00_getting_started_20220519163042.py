...
upper_head_pipe = pygame.Rect(0 , 0 , 0.12.pipe.width , 0.1*pipe.height)
upper_head_pipe.midbotom = upper_pipe.midbottom

bottom_head_pipe = pygame.Rect(0 , 0 , 0.12.pipe.width , 0.1*pipe.height)
bottom_head_pipe.midtop = bottom_pipe.midbtopmidtop
