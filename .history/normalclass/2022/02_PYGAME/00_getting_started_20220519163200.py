...
upper_head_pipe = pygame.Rect(0 , 0 , 0.12.upper_pipe.width , 0.1*upper_pipe.height)
upper_head_pipe.midbotom = upper_pipe.midbottom

bottom_head_pipe = pygame.Rect(0 , 0 , 0.12.bottom_pipe.width , 0.1*bottom_pipe.height)
