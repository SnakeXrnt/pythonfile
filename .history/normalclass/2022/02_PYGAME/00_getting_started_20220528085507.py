...
play_button = pygame.image.load("00_images/playbuttonz.png")
...
game_over = False
game_over_label = pygame.font.Font("00_fonts/BirdyGame.tff", 40)
...
while True:
    ...
    if game_start:
        ...
        screen.blit(title_label_image, title_label_image_rect) if not game_over else screen.blit(
            game_over, title_label_image_rect)
